...
# Based on the simplified 'block' construction from Angela Yuan and crossing edges from Andy Zhang
# 
#
...
#this class initializes a prism with three tetrahedra and can return the various faces for gluing.
    ...
    def __init__(self, isR = False):
        ...
        #add top, bottom, diagonal, and vertical edge references, each with index in reference to the facet side - STORING THESE WILL CAUSE 
        #Edges by index
...
class Block:
    #this class creates a square-shaped block and stores the indices of the prisms. It can return the prisms (i,j,k,l) for gluing, and the edges making up the embedded crossing. The first entry of i, j, k, l are the indexes of the block
